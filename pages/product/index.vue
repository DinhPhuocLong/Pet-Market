<template>
  <div>
    <div class="flex mt-10 w-[94%] max-w-[1440px] xl:w-11/12 mx-auto">
        <div class="hidden lg:block w-1/4">
            ...
            <div class="grid grid-cols-2 xl:grid-cols-3 gap-2 mt-4">
                <div class="border border-solid border-gray-300 rounded-lg overflow-hidden hover:border-black cursor-pointer">
                    <img src="https://wpbingosite.com/wordpress/petio/wp-content/uploads/2021/03/brand-1.jpg" alt="">
                </div>
                ...
                <li class="border-b border-solid border-gray-300 pb-4 mt-4">
                    <div class="flex flex-row">
                        <div class="w-5/12 pr-8">
                            <img class="border border-solid border-gray-300 rounded-lg"
                                src="https://wpbingosite.com/wordpress/petio/wp-content/uploads/2020/12/product-4.jpg"
                                alt="">
                        </div>
                        <div class="flex flex-col w-7/12">
                            <div class="flex justify-start">
                                <button type="button" class="focus:outline-none mr-1">
                                    <svg class="block h-3 w-3 text-yellow-400" fill="currentColor"
                            ...
                            <p class="truncate mt-1 text-gray-400">
                                <a href="overflow-truncate">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima, tempore.
                                </a>
                            </p>
        ...
        <div class="w-full lg:w-3/4">
            <div class="w-[94%] xl:w-11/12 mx-auto flex justify-between lg:justify-end gap-x-2">
                <div class="toggle-open-options cursor-pointer border border-black rounded-lg p-1 lg:hidden hover:bg-red-500 hover:border-red-500 transition-all duration-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-adjustments" width="32"
                ...
                <div class="toggle-items-option fixed top-0 left-0 bg-white shadow-md w-80 h-full animate-OpenMenuMobile"
                    style="display:none; z-index: 9999;">
                    <div class="p-4 flex justify-end font-bold bg-white shadow-md">
                        <button class="toggle-close-options focus:outline-none italic">
                            Close
                    ...
                    <div class="px-6 pt-8 pb-20 overflow-y-scroll h-full">
                        ...
                        <div class="border-b border-solid border-gray-200 mt-3 lg:mt-10">
                            <h3 class="text-2xl font-bold pb-3">Thương Hiệu</h3>
                        </div>
                ...
                <div class="lg:flex gap-x-4 border border-solid border-black rounded-full py-2.5 px-6 hidden">
                    <a href="" class="inline-block">
                        <div class="grid grid-cols-2 gap-px grid-icon-bg-gray">
                    ...
                    <a href="" class="inline-block">
                        <div class="grid grid-cols-3 gap-px grid-icon-bg-black">
                            <span class="bg-black w-1.5 h-1.5"></span>
                            <span class="bg-black w-1.5 h-1.5"></span>
                            <span class="bg-black w-1.5 h-1.5"></span>
                            <span class="bg-black w-1.5 h-1.5"></span>
                    ...
                    <a href="" class="inline-block">
                        <div class="grid grid-cols-2 gap-y-px items-center justify-items-center grid-icon-bg-black">
                            <span class="bg-black w-1.5 h-1.5"></span>
            ...
            <div class="mt-10 w-[94%] mx-auto grid grid-cols-2 md:grid-cols-3 gap-6">
                <div class="w-full box-border">
                    <div
                        class="relative mx-px product-img border border-solid border-gray-200 rounded-lg overflow-hidden">
                        <a href="#">
                            <img src="https://wpbingosite.com/wordpress/petio/wp-content/uploads/2020/12/product-11-450x450.jpg"
                                class="mx-auto" width="450" height="450" alt="">

                            <!-- product buttons -->
                            <div class="flex flex-col text-center absolute bottom-2 right-1">
                                <a href="#" class="iline-block text-center w-8 h-8 md:w-10 md:h-10 leading-8 md:leading-10
                                ...
                                <button class="iline-block text-center w-8 h-8 md:w-10 md:h-10 leading-8 md:leading-10
                                ...
                                <button class="iline-block text-center w-10 h-10 leading-10 
                                        border border-solid border-gray-300 mb-2 rounded-full
                                        transform translate-x-12 transition-all duration-500
                                        hover:text-white hover:bg-red-500
                                        opacity-0 product-buttons hidden">
                                    <i class="fas fa-shopping-cart focus:outline-none"></i>
                                </button>
                            </div>
                        </a>
                        <!-- sale -->
                    ...
                    <div class="py-4 text-[16px] font-bold text-center">
                        ...
                        <div class="flex justify-center my-2">
                            <button type="button" class="focus:outline-none mr-1">
                                <svg class="block h-4 w-4 text-yellow-400" fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path
                                        d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                                </svg>
                        ...
                        <p class="mb-2">
                            <a class="hover:text-red-500" href="#">Aliquam id lorem vel nisl blandit dapibus</a>
                        </p>
    ...
    <div class="mx-auto px-4 mt-20">
        <nav class="flex flex-row flex-nowrap justify-center items-center" aria-label="Pagination">
            ...
            <a class="flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-gray-200 bg-white text-black hover:border-gray-300"
                href="#" title="Page 1">
                1
            </a>
            <a class="flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-gray-200 bg-white text-black hover:border-gray-300"
            ...
            <a class="flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-black bg-black text-white pointer-events-none"
