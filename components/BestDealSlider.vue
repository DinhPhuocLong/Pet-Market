<template>
    <div class="mt-20 w-full">
        ...
        <client-only>
            <carousel
                class="owl-border w-full max-w-full"
                :nav="false"
                :dots="false"
                :items="5"
                :margin="0"
            ...
            >
                <div class="border-r border-solid border-[#ebebeb]">
                    <div class="relative product-img">
                        <a href="#">
                            <img
                                src="https://wpbingosite.com/wordpress/petio/wp-content/uploads/2020/12/product-26-450x450.jpg"
                                class="mx-auto"
                                width="450"
                                height="450"
                                alt=""
                            ...
                            >
                                <a
                                    href="#"
                                    class="p-2 inline-block text-center w-10 h-10 leading-10 
                    ...
                    >
                        ...
                        <p class="truncate px-8">
                            <a
                                ...
                                href="#"
                                >Ut rhoncus venenatis justo, eu vulputate
                                nunc</a
                            >
                        </p>
